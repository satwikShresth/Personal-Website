...
export const projects: Array<Projects> = [
   ...
   },
   {
      ...
      description: [
         <>
            A simple group project where the goal was to master JavaScript as a
            raw language and build applications and features from scratch
         </>,
         <>
   ...
   },
   {
      ...
      description: [
         ...
         <>
            No courses, no paywalls—just unfiltered opinions and unsolicited
            wisdom
         </>,
         <>
   ...
   },
   {
      ...
      description: [
         <>
            A humble assignment I actually hosted—so now it’s your problem to
            check it out.
         </>,
