      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     Auto‑provisions TLS certs and forwards requests to your
                     Hono backend.
                  </p>
               </>
            ),
      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     Holds only system metadata; user data is not persisted
                     here.
                  </p>
               </>
            ),
      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     Indexes all content for real‑time full‑text search with
                     filters.
                  </p>
               </>
            ),
