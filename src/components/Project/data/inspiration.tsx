      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     All UI routes handled client‑side. Every request hits its
                     own path, served through Caddy for seamless navigation.
                  </p>
               </>
            ),
            Footer: (
            ...
            Body: (
               <>
                  <p>
                     ...
                     environment orchestration, security boundaries, and a
                     reproducible dev/staging workflow.
                  </p>
               </>
            ),
            Footer: (
      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     Auto‑provisions TLS certificates and renews them. Routes
                     incoming traffic to the appropriate backend.
                  </p>
               </>
            ),
            Footer: (
            ...
            Body: (
               <>
                  <p>
                     ...
                     work‑order queuing. Fully documented routes make it easy
      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     Stores session data and job queues for lightning‑fast
                     access. Ideal for transient state and rapid task dispatch.
                  </p>
               </>
            ),
            Footer: (
            ...
            Body: (
               <>
                  <p>
                     ...
                     support. Scales horizontally with replicas and
                     partitioning.
                  </p>
               </>
            ),
      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     Self‑manages Python workloads—including numpy and
                     Rust‑accelerated tasks—for complex processing like
      ...
      data: {
         ...
         Card: {
            ...
            Body: (
               <>
                  <p>
                     Offloads file uploads/downloads from the backend. Generates
                     signed URLs for secure, direct client access.
                  </p>
               </>
            ),
            Footer: (
...
const VideoDemo = () => {
   ...
   return (
      <VStack gap={4} align="stretch">
         <Text fontSize="lg" fontWeight="bold" textAlign="center"></Text>
         <Box
            width="100%"
            maxWidth="600px"
            mx="auto"
