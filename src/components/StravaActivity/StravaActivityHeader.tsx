...
export function StravaActivityHeader({ name, type, sportType, startDate, athleteId }: StravaActivityHeaderProps) {
  const stravaUrl = athleteId ? `https://strava.com/athletes/${athleteId}` : 'https://strava.com'

  return (
    <Box p={5} pb={4} overflow="hidden" borderTopRadius="2xl" position="relative">
