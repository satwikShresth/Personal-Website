          ...
          >
            ...
            >
              ...
              >
                ...
                <Icon as={GrDocumentPdf} w={{ base: 4, md: 6 }} h={{ base: 4, md: 6 }} mr={2} />
                Resume
              </Button>
              <Button
                as={Link}
              ...
              >
                ...
                <Icon as={FaGithub} w={{ base: 4, md: 6 }} h={{ base: 4, md: 6 }} mr={2} />
                Github
              </Button>
              <Button
                _hover={{
              ...
              >
                ...
                <Icon as={FaLinkedin} w={{ base: 4, md: 6 }} h={{ base: 4, md: 6 }} mr={2} />
                LinkedIn
              </Button>
            </Flex>
          </Box>
