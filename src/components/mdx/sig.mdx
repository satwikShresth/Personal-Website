...
export const metadata = {
  ...
  date: "2025-05-06",
  description: "I worked at Susquehanna International Group for my last co-op in this blog i will be talking about all the technical projects that I built and my overall experince",
  estimatedReadTime: "1",
  tags: [
    "opinion",
    "portfolio",
...
<Heading as="h1" size="2xl" mb={6}>
  My Time at Susquehanna International Group
</Heading>
