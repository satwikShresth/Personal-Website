...
export const metadata = {
  ...
  date: "2025-05-06",
  description: "I worked at Susquehanna International Group for my last co-op. In this blog, I will be talking about all the technical projects that I built and my overall experience",
  estimatedReadTime: "1",
  tags: [
    "opinion",
    "portfolio",
