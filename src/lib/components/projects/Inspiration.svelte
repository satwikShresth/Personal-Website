    ...
    <div class="lg:col-span-8 space-y-8">
      <div class="space-y-4 text-foreground leading-relaxed text-base">
        <ul class="space-y-2 list-disc pl-6">
          <li>
            FERPA-compliant open-source plagiarism detection software developed
            for Drexel University, enabling self-hosted and privacy-focused
            implementation
          </li>
          <li>
            Incorporates multi-modal detection techniques based on Stanford
            research papers with enhanced visualization for software similarity
            analysis
          </li>
        </ul>
      </div>
      ...
      <div class="py-4">
        {#if import.meta.env.VITE_PUBLIC_S3_INSP_VIDEO}
          <div class="w-full flex flex-col items-center gap-4">
            <div
              class="w-full max-w-150 mx-auto rounded-lg overflow-hidden shadow-lg"
            >
              ...
              <video
                ...
                width="100%"
                class="rounded-lg"
                src={import.meta.env.VITE_PUBLIC_S3_INSP_VIDEO}
                preload="metadata"
              >
